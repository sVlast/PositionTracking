...
namespace PositionTracking.Engine
{
    public enum Countries
    {
        ...
        BO,
        /// <summary>Caribbean Netherlands</summary>
        BQ,
        ...
        CF,
        /// <summary>Congo (Republic)</summary>
        CG,
        ...
        FJ,
        /// <summary>Falkland Islands (Islas Malvinas)</summary>
        FK,
        ...
        GR,
        /// <summary>South Georgia & South Sandwich Islands</summary>
        GS,
        ...
        HK,
        /// <summary>Heard & McDonald Islands</summary>
        HM,
        ...
        MH,
        /// <summary>Macedonia (FYROM)</summary>
        MK,
        /// <summary>Mali</summary>
        ML,
        /// <summary>Myanmar (Burma)</summary>
        MM,
